...
export const AccountUI = ({ profile }: Props) => {
  ...
  return (
    <div className="max-w-xl mx-auto bg-background p-8 rounded-lg mt-10 shadow">
        ...
        <div>
          ...
          >
            ...
            <div className="py-4 flex flex-col items-center">
              {isUploading ? (
                <Loader2Icon className="size-10 text-gray-400 animate-spin mb-2" />
              ) : image ? (
                <img
                  src={image}
                  alt="프로필 미리보기"
                  className="size-24 object-cover rounded-full mx-auto mb-2 border"
                />
              ) : (
